...
* @{
*/
#define PRODUCT_KEY "3748a3f6b4c44123b87b502d6a9db727"
/**@} */
/**@name Product Secret  
* @{
*/
#define PRODUCT_SECRET "c69c98fc88be4f888f42c25f7ab92153"
...
#define buzzer_BITOFFSET                     4
#define buzzer_LEN                           1
#define Relay_BYTEOFFSET                    0
#define Relay_BITOFFSET                     5
#define Relay_LEN                           1
#define DCout_BYTEOFFSET                    0
#define DCout_BITOFFSET                     6
#define DCout_LEN                           1
#define InfTube_BYTEOFFSET                    7
#define InfTube_BITOFFSET                     0
#define InfTube_LEN                           1
#define InfPyr_BYTEOFFSET                    7
#define InfPyr_BITOFFSET                     1
#define InfPyr_LEN                           1
...
#define InfReciverAdd_RATIO                         1
#define InfReciverAdd_ADDITION                      0
#define InfReciverAdd_MIN                           0
#define InfReciverAdd_MAX                           255
#define InfReciverCmd_RATIO                         1
#define InfReciverCmd_ADDITION                      0
#define InfReciverCmd_MIN                           0
#define InfReciverCmd_MAX                           255
#define LightStr_RATIO                         0.01
#define LightStr_ADDITION                      0
#define LightStr_MIN                           0
#define LightStr_MAX                           500
/**@} */
...
typedef struct {
  ...
  uint32_t valueInfReciverAdd;
  uint32_t valueInfReciverCmd;
  float valueLightStr;
} dataPoint_t;
...
typedef struct {
  ...
  uint8_t valueInfReciverAdd;
  uint8_t valueInfReciverCmd;
  uint16_t valueLightStr;
} devStatus_t; 
